...
namespace Atropos
{
    ...
    public class QRMainActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            SetContentView(Resource.Layout.QRMain);
            ...
            buttonScanCustomView.Click += async delegate
            {
                ...
                zxingOverlay = LayoutInflater.FromContext(this).Inflate(Resource.Layout.QRZXingOverlay, null);

                //Find the button from our resource layout and wire up the click event
                flashButton = zxingOverlay.FindViewById<Button>(Resource.Id.qr_btn_flashlight);
            ...
            {
                StartActivity(typeof(QRImageActivity));
            };
        }
