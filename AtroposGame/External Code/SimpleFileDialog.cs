...
namespace Atropos.External_Code
{
    public class SimpleFileDialog
    {
        ...
        private AlertDialog.Builder CreateDirectoryChooserDialog(String title, List<String> listItems, EventHandler<DialogClickEventArgs> onClickListener)
        {
            ...
            _mTitleView1.SetPadding(10, 10, 0, 15);
            ...
            titleLayout.VerticalScrollBarEnabled = true;
            ...
            currentSelection.SetPadding(10, 5, 0, 3);
            ...
            _mTitleView.SetPadding(10, 0, 10, 5);
    ...
    internal class SimpleArrayAdaper : ArrayAdapter<String>
    {
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            if (v is TextView)
            {
                ...
                //tv.SetTextSize(ComplexUnitType.Dip, 10.0f);
                //var layout = new ViewGroup.MarginLayoutParams(tv.LayoutParameters);
                //layout.SetMargins(5, 3, 5, 3);
