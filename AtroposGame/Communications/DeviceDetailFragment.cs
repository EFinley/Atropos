...
//            FindViewById<Button>(Resource.Id.btn_test).Click += (sender, args) =>
//                {
...
//            //{
//            //    FindViewById<Button>(Resource.Id.btn_test).Visibility = ViewStates.Visible; //**
...
//            view.Text = string.Empty;
//            FindViewById<Button>(Resource.Id.btn_test).Visibility = ViewStates.Gone;
