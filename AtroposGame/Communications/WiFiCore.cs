...
{
    public class WifiCore // Kind of like a stripped-down version of Activator, without the need to Activate it.  Might become full Activator in future.
    {
        protected string _tag = "WifiCore";

        // A central cancellation coordinator
        protected CancellationTokenSource _cts;
        public CancellationToken StopToken { get { return _cts?.Token ?? CancellationToken.None; } }

        public WifiCore(CancellationToken? stopToken = null)
        {
        ...
        public static void RunSendingLooper(WifiClient client)
        {
            Task.Run(async () =>
            {
