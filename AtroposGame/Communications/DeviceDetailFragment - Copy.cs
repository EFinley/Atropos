...
//namespace _com.Atropos.Communications
//{
...
//            // After the group negotiation, we assign the group owner as the message
//            // server. The message server is a single threaded, single connection server
//            // socket.
...
//                        serverSocket.ReuseAddress = true; // Might help...?  Nope, don't think so.
